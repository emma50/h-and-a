  ...
  return (
    <Box bg={{base: "#FAFDFF", _dark: "#000A0F"}} color={{ base: "#000A0F", _dark: "#ffffff"}} p="4rem" maxH={{base: "auto", lg: "860px"}} mx="auto" py={{base: "80px", lg: "80px"}} px={{base: "10px", lg: "10px"}} id="about">
      <Flex flexDirection="column" gap="10px">
        ...
        <Flex flexDirection="column" alignItems="center" gap="16px" pb="1.5rem">
          <Text textAlign="center" color={{ base: "#036096", _dark: "#69C6FC" }} fontWeight="600" fontSize="30px" lineHeight="36px" height={{base: "auto", md: "36px"}}>Mission Statement</Text>
        ...
        <Flex flexDirection="column" alignItems="center" gap="16px">
          <Text textAlign="center" color={{ base: "#036096", _dark: "#69C6FC" }} fontWeight="600" fontSize="30px" lineHeight="36px" height={{base: "auto", md: "36px"}}>Vision Statement</Text>
