...
export default function Hero() {
  return (
    <>
      <Flex gap="64px" align="center" justify="space-between" flexDirection={{ base: "column", lg: "row" }} maxH={{base: "auto", lg: "467px"}} py="80px" px="20px" mx="auto" maxW="1232px" maxHeight={{ base: "auto", lg: "467px" }}>
        <Left />
        <Right />
      </Flex>
      <Box>
...
export const Left = () => {
  return (
    <Flex height={{ base: "auto", lg: "467px" }} maxW="522px" flexDir="column" justify="center">
      ...
      <Flex flexDirection="column" gapY="1rem"> 
        <Flex flexDirection="column" gapY="1rem">
          <Text fontSize="53.34px" fontWeight="800" lineHeight="65.5px" color={{ base: "#036096", _dark: "#69C6FC" }} maxW="513px" textAlign="start">
            Launch <Text as="span" color={{ base: "#000000", _dark: "#ffffff" }}>your future career into tech</Text>
          </Text>
          <Text maxW="457px" textAlign="start" color={{base: "#000000", _dark: "#ffffff"}} fontWeight="400" fontSize="20px" lineHeight="33px">Our robust curriculum and immersive classes at <Text as="span" color={{ base: "#036096", _dark: "#69C6FC" }}>H&A infotech</Text> helps equip students with the relevant skills needed to launch a successful career</Text>
        </Flex>

        {/* Buttons */}
        <Flex gap="1rem">
          <Box>
            <Link href="/" bg={{base: "#036096", _dark: "#69C6FC"}} color={{base: "#FFFFFF", _dark: "#000000"}} px="1.25rem" py="0.625rem" borderRadius="0.313rem" fontSize="1rem" fontWeight="600" width="204px" height="60px" rounded="7px">
              Register now
            </Link>
          </Box>
          <Box>
            <Link href="/" bg={{base: "#F0F9FF", _dark: "#000D14"}} color={{base: "#036096", _dark: "#69C6FC"}} px="1.25rem" py="0.625rem" borderRadius="0.313rem" fontSize="1rem" fontWeight="600" width="204px" height="60px" rounded="7px" border={{base: "1px solid #036096", _dark: "1px solid #69C6FC"}}>
              Explore courses
            </Link>
          </Box>
        </Flex>
